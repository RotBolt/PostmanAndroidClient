package io.rotlabs.postmanandroidclient.di.module
...
import io.rotlabs.postmanandroidclient.utils.network.FakeConnectivityCheckerImpl
...
class TestAppModule {
    ...
    fun providesConnectivityChecker(@ApplicationContext appContext: Context): ConnectivityChecker =
        FakeConnectivityCheckerImpl(appContext)
